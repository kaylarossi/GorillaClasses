...
public class GorillaTest {
    ...
    public void testGroupA() {
        Gorilla g = new Gorilla("Silver", 1980, 2, 'm');
        assertEquals("Silver", g.name());
        assertEquals(1980, g.year());
        assertEquals(2, g.month());
        assertFalse(g.isFemale());
        assertThrows(AssertionError.class, () -> new Gorilla(null, 1980, 2,'m'));
        assertThrows(AssertionError.class, () -> new Gorilla("", 1980, 2,'m'));
        assertThrows(AssertionError.class, () -> new Gorilla("Silver", 1980, 13,'f'));
        assertThrows(AssertionError.class, () -> new Gorilla("Silver", 1980, 2,'z'));
    ...
    // q's year before r's, same month
       ...
       // Gorilla noMom = new Gorilla("noMom", 2020, 4,'m', null, po);
       // Gorilla noPop = new Gorilla("noPop", 2020, 6, 'f', mo, null);
       // assertThrows(NullPointerException.class, () ->  { noMom.mom(); } );
        //assertThrows((NullPointerException.class, () - > { noPop.pop(); }  );
        ...
        assertEquals(true, bb.areSiblings(aa));
        assertEquals(false, ee.areSiblings(bb));
        assertEquals(false, aa.areSiblings(ee));
